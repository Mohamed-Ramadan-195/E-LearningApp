...
import com.example.e_learningapp.databinding.FragmentInstructorChatBinding;
...
public class InstructorChatFragment extends Fragment {
    FragmentInstructorChatBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentInstructorChatBinding.inflate(inflater, container, false);
